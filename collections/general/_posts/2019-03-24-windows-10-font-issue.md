...
![MapTool with blurriness on Windows](/assets/img/WindowsAntiBlurrySettingProblem.webp){: .post-example }
...
![Finding the advanced scaling settings for Windows Display settings ](/assets/img/WindowsAntiBlurrySystem-Display-Settings.webp){: .post-example }
...
![Allowing Windows to fix apps so they are not blurry](/assets/img/WindowsAntiBlurrySystem-Display-Settings-Advanced-1.webp){: .post-example }

Once you save the settings and restart MapTool the fonts should be better behaved.

![MapTool with blurriness fixed](/assets/img/WindowsAntiBlurrySettingFix.webp){: .post-example }
