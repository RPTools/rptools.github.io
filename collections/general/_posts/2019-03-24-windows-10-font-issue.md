...
<img class="post-example" src="/assets/img/WindowsAntiBlurrySettingProblem.webp" alt="WindowsAntiBlurrySettingProblem">
...
<img class="post-example" src="/assets/img/WindowsAntiBlurrySystem-Display-Settings.webp" alt="WindowsAntiBlurrySystem-Display-Settings">
...
<img class="post-example" src="/assets/img/WindowsAntiBlurrySystem-Display-Settings-Advanced-1.webp" alt="WindowsAntiBlurrySystem-Display-Settings-Advanced-1">

Once you save the settings and restart MapTool the fonts should be better behaved.

<img class="post-example" src="/assets/img/WindowsAntiBlurrySettingFix.webp" alt="WindowsAntiBlurrySettingFix">
