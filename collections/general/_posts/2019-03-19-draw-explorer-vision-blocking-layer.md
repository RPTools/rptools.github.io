...
tags: feature drawing vbl vision maptool
author: jagged
image: /assets/img/map4.webp
...
![example map](/assets/img/map1.webp){: .post-example }
...
![example map covered in VBL](/assets/img/map2.webp){: .post-example }
...
![drawing explorer: remove from VBL](/assets/img/map3.webp){: .post-example }

Your vision layer is complete. The job is done!

![Example map with complete VBL](/assets/img/map4.webp){: .post-example }
