...
author: bard
image: /assets/img/PORSupport.webp
...
![PDF image extraction](/assets/img/PDF-Support.webp){: .float .float--left .float--30 }
...
![POR token support](/assets/img/PORSupport.webp){: .float .float--left .float--30 }
...
![Hero Lab data in Edit Token dialog showing HTML tab](/assets/img/HeroLabsToken.webp){: .post-example }
...
![Hero Lab data in Edit Token dialog showing Images tab](/assets/img/HeroLabsTokenImages.webp){: .post-example }
</section>
