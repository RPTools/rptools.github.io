...
tags: java maptool
author: bard
image: /assets/img/JavaIcon.webp
...
<img class="post-example" src="/assets/img/StartupPreferences.webp" alt="StartupPreferences">
...
Update: If you put settings in that break MapTool, you can reset them back to their default. Please see [Resetting MapTool JVM Settings](/2019/04/resetting-maptool/) for more detail.
