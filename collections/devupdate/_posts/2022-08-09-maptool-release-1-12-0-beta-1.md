...
Visit the full [Change log](https://github.com/RPTools/maptool/blob/1.12.0-beta.1/CHANGE_LOG.md)

Download the Beta version [here](https://github.com/RPTools/maptool/releases/tag/1.12.0-beta.1).

Want to know more as a tester? Give the [Issue page](https://github.com/RPTools/maptool/issues) a look.

For those new to MapTool, yes, it is completely free and community driven. Join our [discord server]({{ site.data.links.discord | escape }}) if you want to meet the awesome community.
