---
layout: post
title: MapTool 1.10.3 Released
tags: maptool release
author: bard
image: /assets/img/logos/RPTools_Map_Logo_512.png
slug: maptool-1-10-3-released
---

Some windows users experienced a Null Point Exception (NPE) when closing MapTool 1.10.2. This release fixes that
problem.

![MapTool 1.10.3 meme](/assets/img/Maptool1_10_3_meme.webp){: .post-example }
