...
This is a bug release to fix a bug encountered when adding new folders to the Resource Library. It also contains an update to the Macro Editor Help to include many missing functions. Please refer to the [MapTool 1.9.0](/2021/06/maptool-1-9-0-released/) Release post for a full list of MapTool 1.9 features.
