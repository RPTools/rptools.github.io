...
## Highlights
- New audio capabilities – MapTool now supports playing/managing audio streams at the local client through new macro functions. A volume slider and mute button have also been added to the toolbar. ![sound slider](/assets/img/SoundSlider.webp){: .post-example }
