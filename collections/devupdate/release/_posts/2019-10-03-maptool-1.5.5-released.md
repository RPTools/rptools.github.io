...
## Highlights
- New audio capabilities – MapTool now supports playing/managing audio streams at the local client through new macro functions. A volume slider and mute button have also been added to the toolbar. <img class="post-example" src="/assets/img/SoundSlider.webp">
